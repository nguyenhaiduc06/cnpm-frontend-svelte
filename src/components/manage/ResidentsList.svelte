<script>
    ...
    import { CollectionResidentChanges, CollectionResidentSnapshots } from "../../utils/database/collections";

    const dispatch = createEventDispatcher();

    const collection = CollectionResidentSnapshots;
    export let sort = "";
    export let filter = "";
    ...
    async function maskAsDead() {
        ...
        for (const recordId of Object.keys(bulkSelected)) {
            ...
            //create new change
            await ApiClient.collection(CollectionResidentChanges.name).create({
                resident,
